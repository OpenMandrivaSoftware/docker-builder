...
err_type = [r'Segmentation fault',
            ...
            r'failed to allocate (.*) bytes for output file: Cannot allocate memory',
            r'cp: cannot stat (.*):(.*)',
            r'can\'t find file to patch at input line (.*)',
            r'No matching package to install: (.*)',
            r'package (.*) requires (.*) but none of the providers can be installed$',
            r'unable to execute command: (.*)',
            r'(.*) is a protected member of (.*)',
            r'undefined reference to (.*)',
            r'no matching function for call to (.*)',
            r'bytecode stream in file (.*) generated with (.*)',
            r'Could not find a configuration file for package (.*)',
            r'variable has incomplete type (.*)',
            r'File must begin with (.*)', r'Bad source: (.*)',
            r'File not found: (.*)', r'Installed \(but unpackaged\) file\(s\) found',
            r'cannot find -l(.*)', r'implicit declaration of function (.*)',
            r'\'(.*)\' file not found', r'use of undeclared identifier (.*)',
            r'function cannot return function type (.*)',
            r'unknown type name (.*)', r'incomplete definition of type (.*)',
            r'Problem encountered: Man pages cannot be built: (.*)',
            r'format string is not a string literal (.*)',
            r'Failed to find required (.*) component (.*)',
            r'Package (.*), required by (.*), not found',
            r'CMake Error at (.*)',
            r'error: (.*)',
            r"Couldn't find include (.*)",
            r'(.*) Stop']

# Common "errors" from chroot install scripts while inside a container...
not_an_error = [r'error: lua script failed:']
