...
err_type = [r'Segmentation fault',
            ...
            r'File must begin with (.*)', 'Bad source: (.*)',
            r'File not found: (.*)', 'Installed \(but unpackaged\) file\(s\) found',
            r'cannot find -l(.*)', 'implicit declaration of function (.*)',
            r'\'(.*)\' file not found', 'use of undeclared identifier (.*)',
            r'function cannot return function type (.*)',
            r'unknown type name (.*)', 'incomplete definition of type (.*)',
