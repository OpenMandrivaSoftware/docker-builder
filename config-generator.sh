...
config_opts['chroot_setup_cmd'] = ('install', 'basesystem-minimal', 'distro-release-OpenMandriva', 'gnupg', 'shadow', 'rpm-build', 'wget', 'task-devel', 'clang', 'openmandriva-repos-pkgprefs', 'rpmlint-distro-policy', 'dwz')
